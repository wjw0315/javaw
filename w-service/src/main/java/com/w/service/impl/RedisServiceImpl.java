...
import com.w.service.IRedisService;
import com.w.util.JsonUtil;
...
public class RedisServiceImpl implements IRedisService {
    ...
    @Override
    public void hmset(final String key, Object obj)  throws Exception{
        Assert.hasText(key,"Key is not empty.");

        final Map<byte[], byte[]> data=JsonUtil.readJsonByteMap(JsonUtil.getJsonString(obj));
...
//                connection.hMSet(serializer.serialize(key),data);
    ...
    @Override
    public <T> T hget(final String key, final Class<T> clz)  throws Exception{
        Assert.hasText(key,"Key is not empty.");
    ...
    @Override
    public<T> List<T>  hmGetAll(final String key, final Class<T> clz) throws Exception{
        Assert.hasText(key,"Key is not empty.");
